...
AVANZAR:
    ...
    BSF PORTC,0 ;MOTOR1_AVANZAR
    BCF PORTC,1 ;MOTOR1_REVERSA
    BSF PORTC,2 ;MOTOR2_AVANZAR
    BCF PORTC,3 ;MOTOR2_REVERSA
    BCF PORTC,4 ;LED_INDICADOR_IZQUIERDA
    BCF PORTC,5 ;LED_INDICADOR_STOP
    BCF PORTC,6 ;LED_INDICADOR_DERECHA
    GOTO MAIN

GIRO_DERECHA:

     BCF PORTC,0 ;MOTOR1_AVANZAR
     BCF PORTC,1 ;MOTOR1_REVERSA
     BSF PORTC,2 ;MOTOR2_AVANZAR
     BCF PORTC,3 ;MOTOR2_REVERSA
     BCF PORTC,4 ;LED_INDICADOR_IZQUIERDA
     BCF PORTC,5 ;LED_INDICADOR_STOP
     BSF PORTC,6 ;LED_INDICADOR_DERECHA
    GOTO MAIN
...
GIRO_IZQUIERDA:
    ...
    BSF PORTC,0 ;MOTOR1_AVANZAR
    BCF PORTC,1 ;MOTOR1_REVERSA
    BCF PORTC,2 ;MOTOR2_AVANZAR
    BCF PORTC,3 ;MOTOR2_REVERSA
    BSF PORTC,4 ;LED_INDICADOR_IZQUIERDA
    BCF PORTC,5 ;LED_INDICADOR_STOP
    BCF PORTC,6 ;LED_INDICADOR_DERECHA
    GOTO MAIN
...
STOP:
    ...
    BCF PORTC,3 ;MOTOR2_REVERSA
    BCF PORTC,4 ;LED_INDICADOR_IZQUIERDA
    BSF PORTC,5 ;LED_INDICADOR_STOP
    BCF PORTC,6 ;LED_INDICADOR_DERECHA
    GOTO MAIN
...
INISYS:
    ...
    BCF TRISC, 0 ;PORT C0 PORTC,0 ;MOTOR1_AVANZAR SALIDA
    BCF TRISC, 1 ;PORT C1 PORTC,1 ;MOTOR1_REVERSA SALIDA
    BCF TRISC, 2 ;PORT C2 PORTC,2 ;MOTOR2_AVANZAR SALIDA
    BCF TRISC, 3 ;PORT C3 PORTC,3 ;MOTOR2_REVERSA SALIDA
    BCF TRISC, 4 ;PORT C4 PORTC,4 ;LED_INDICADOR_IZQUIERDA SALIDA
    BCF TRISC, 5 ;PORT C5 PORTC,5 ;LED_INDICADOR_STOP SALIDA
    BCF TRISC, 6 ;PORT C6 PORTC,6 ;LED_INDICADOR_DERECHA SALIDA
...
MAIN:
   ...
   BTFSS PORTB,0 ;SENSOR_IZQUIERDA
   GOTO ORDEN1
   GOTO ORDEN2

   ORDEN1:

   BTFSS PORTB,2 ;SENSOR_DERECHO
   GOTO ORDEN3
   GOTO ORDEN4
